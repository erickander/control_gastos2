                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="usu_name" type="text" class="form-control @error('usu_name') is-invalid @enderror" name="usu_name" value="{{ old('usu_name') }}" required autocomplete="usu_name" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="usu_rol" class="col-md-4 col-form-label text-md-right">Rol Familiar</label>

                            <div class="col-md-6">
                                <input id="usu_rol" type="text" class="form-control @error('usu_rol') is-invalid @enderror" name="usu_rol" value="{{ old('usu_rol') }}" required autocomplete="usu_rol" autofocus>
